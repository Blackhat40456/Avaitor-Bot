...
async def send_signal():
    ...
    M2 = await BOT.sendMessage(ID, '\u2705 CONFIRMED ENTRY!\n\nAttempts: 4\n\n\U0001F449 <a href="https://1wzlcz.life/casino/play/1play_1play_mines">Play Here!</a>\n\n' + get_box() + '\n\n\u2705 Tutorial\n\U0001F451 <a href="https://1wrjmw.com/casino/list?open=register&p=mth6">Mines VIP</a>\nPromoCode: <code>REDHAT69</code> use this promo code and get 500% bonus', parse_mode='HTML', reply_markup=single_button('Play Here', 'https://1wzlcz.life/casino/play/1play_1play_mines'), disable_web_page_preview=True)
...
async def send_promo():
    await BOT.sendPhoto(ID, 'static/mines_promo_pic.jpg', 'Create an Account on <a href="https://1wrjmw.com/casino/list?open=register&p=mth6">1WIN</a> & use my promo code - <code>REDHAT69</code> and get 500% bonus\U0001F44D\U0001F4AA\n\nAfter creating your account, send your UID number to <a href="https://t.me/ReDHaT4O4">@ReDHaT4O4</a>\n\n\u26A0\ufe0fDon\'t forget to use my promo code: <code>REDHAT69</code>\n500% Bonus Link: https://1wrjmw.com/casino/list?open=register&p=mth6', parse_mode='HTML', reply_markup=single_button('Create Account', 'https://1wrjmw.com/casino/list?open=register&p=mth6'))
