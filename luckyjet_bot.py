...
async def send_signal():
    ...
    M2 = await BOT.sendPhoto(ID, 'static/jet_pic.jpg', f'\U0001F3AF Enter confirmed \U0001F3AF\n\U0001F4F1 Site: \U0001F449 <a href="https://1wrjmw.com/casino/list?open=register&p=mth6">Click Here To Play</a> \U0001F448\n\n\U0001F4B0 Exit at {random.randint(130, 250) / 100}x\n\nUSE PROMO: <code>REDHAT69</code> and get 500% Bonus', parse_mode='HTML', reply_markup=single_button('Play Here', 'http://1wdpnk.life/v3/reg-form-aviator#mth6'))
